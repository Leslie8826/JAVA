...
public class MCQ
{
	public static void main(String[] args) 
	{
		...
		int[] numQuest = new int[number_questions]; // Array to store the question number (before content of the question. Example--> 1. xxxx, 2. ddddd etc )
		int[] numAnswer = new int[number_answers]; // Array to store the answer number (before content of the answer. Example--> 1. xxxx, 2. ddddd etc )
		int[] choice_mcq = new int[number_questions];  // answer of student
