...
// The for loop ask the right number of time the user to type a character
// Issue: only the last character typed by the user is displayed in the 
//        final array

import java.util.Scanner;

public class array7_v3 {
